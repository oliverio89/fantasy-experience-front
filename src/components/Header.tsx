...
const Header: FunctionComponent<ContentType> = memo(({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-start pt-[50px] px-[80px] pb-[50px] box-border max-w-full text-center text-101xl text-black font-milonga mq750:pl-10 mq750:pr-10 mq750:pb-[42px] mq750:box-border ${className}`}
    >
      <img
        className="w-full h-[625px] absolute !m-[0] top-[0px] right-[0px] left-[0px] max-w-full overflow-hidden shrink-0 object-cover"
        alt=""
        src="/2hmediaz9jv6wrkrpaunsplash-1@2x.png"
      />
      <div className="flex-1 rounded-xl bg-oldlace-200 flex flex-col items-end justify-start pt-[125px] pb-[125px] pl-[200px] pr-[250px] box-border gap-[9px] max-w-full z-[1] lg:pl-[130px] lg:pr-[130px] lg:box-border mq750:pt-[133px] mq750:pb-[108px] mq750:pl-16 mq750:pr-[65px] mq750:box-border mq450:pl-5 mq450:pr-5 mq450:box-border">
